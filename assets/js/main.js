(function() {
	...
	$('#form').on('submit', function(event) {
		...
		$('#form').append("<div class='ans-frame'><div class='ans-bloc'><div class='ans-inner'><svg><use xlink:href='assets/img/layout/symbol-defs.svg?1#icon-refresh' /></svg></div></div></div>").find(".ans-frame").fadeIn('fast');
		$.ajax({
